...
version: 1.56.1
author: hermes-CCC (ported from Hermes Agent by NousResearch; originally 宝玉 / JimLiu)
license: MIT
metadata:
  hermes:
...
Adapted from [baoyu-infographic](https://github.com/JimLiu/baoyu-skills) for the hermes-CCC skill pack (originally built for Hermes Agent's tool ecosystem).
